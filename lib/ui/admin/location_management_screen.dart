                    ...
                    data: (shops) {
                      ...
                      return Column(
                        ...
                        children: [
                          ...
                          InkWell(
                            onTap: isEditing ? null : () => SearchableSelector.show(
                              context: context,
                              title: 'Select Shop',
                              items: shopMap,
                              labelKey: 'shop_name',
                            ...
                            child: Container(
                              padding: const EdgeInsets.all(12),
                              decoration: BoxDecoration(
                                color: isEditing ? Colors.grey.shade50.withOpacity(0.5) : Colors.grey.shade50,
                                borderRadius: BorderRadius.circular(12),
                                border: Border.all(color: Colors.grey.shade300),
                              ),
                              child: Row(
                                children: [
                                  Icon(Icons.storefront_rounded, size: 18, color: isEditing ? Colors.grey : AppColors.cardSales),
                                  const SizedBox(width: 12),
                                  Expanded(child: Text(shopName, style: TextStyle(fontWeight: FontWeight.w700, fontSize: 13, color: isEditing ? Colors.grey : AppColors.textPrimary))),
                                  if (!isEditing) const Icon(Icons.search_rounded, size: 16, color: Colors.grey),
                                ],
                              ),
                            ),
                          ),
